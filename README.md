...
Follow the [Unifi-gateway-wpa-supplicant guide by Evie Lau](https://github.com/evie-lau/unifi-gateway-wpa-supplicant) for full details on the wpa_supplicant service setup. The key UDM Pro Max specific difference is using `eth9.0` instead of `eth9` — covered in Step 4.
